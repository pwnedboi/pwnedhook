...
public:
    ...
    int m_nServerCount;                 //0x01B0
    int m_nCurrentSequence;             //0x01B4
    ...
    int m_iCurClockOffset; //0x0200
    int m_nServerTick; //0x0204
    int m_nClientTick; //0x0208
    int m_nDeltaTick; //0x020C
